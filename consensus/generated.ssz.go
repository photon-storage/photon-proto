...
// Hash: 0504fe2202179022051183322f3ae5c5e5520e8f873f5663464a7a8c7bb11b6e
package pbc
...
func (a *Audit) UnmarshalSSZ(buf []byte) error {
	...
	// Field (0) 'Start'
	a.Start = Slot(ssz.UnmarshallUint64(buf[0:8]))

	// Field (1) 'EncodedHash'
	if cap(a.EncodedHash) == 0 {
		a.EncodedHash = make([]byte, 0, len(buf[8:40]))
	}
	a.EncodedHash = append(a.EncodedHash, buf[8:40]...)

	// Field (2) 'EncodedSize'
	a.EncodedSize = ssz.UnmarshallUint64(buf[40:48])

	// Field (3) 'NumBlocks'
	a.NumBlocks = ssz.UnmarshallUint32(buf[48:52])
