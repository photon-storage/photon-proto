...
// Hash: 7f76d452b22903416989f7f7e42899a94c6259c7630d8b9e12155a31ede70e38
package pbc
...
func (a *Audit) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (4) 'CompletedSlot'
	dst = ssz.MarshalUint64(dst, uint64(a.CompletedSlot))
...
func (a *Audit) UnmarshalSSZ(buf []byte) error {
	...
	// Field (4) 'CompletedSlot'
	a.CompletedSlot = Slot(ssz.UnmarshallUint64(buf[48:56]))
...
func (a *Audit) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field (4) 'CompletedSlot'
	hh.PutUint64(uint64(a.CompletedSlot))
