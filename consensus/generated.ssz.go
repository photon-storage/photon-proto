...
// Hash: 5b0bb9fe72a9a74b908913fc7a14fa4d14cf56f878a7d2d83d4a1b445a54e4a2
package pbc
...
func (s *State) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o8, o9, o10, o11, o19, o20 uint64
	...
	if cap(s.AuditQueueRoot) == 0 {
		s.AuditQueueRoot = make([]byte, 0, len(buf[425:457]))
	}
	s.AuditQueueRoot = append(s.AuditQueueRoot, buf[425:457]...)

	// Field (17) 'EventQueueRoot'
	if cap(s.EventQueueRoot) == 0 {
		s.EventQueueRoot = make([]byte, 0, len(buf[457:489]))
	}
	s.EventQueueRoot = append(s.EventQueueRoot, buf[457:489]...)

	// Field (18) 'ReserviorBalance'
	s.ReserviorBalance = ssz.UnmarshallUint64(buf[489:497])

	// Offset (19) 'Storage'
	if o19 = ssz.ReadOffset(buf[497:501]); o19 > size || o11 > o19 {
		return ssz.ErrOffset
	}

	// Offset (20) 'RandaoMixes'
	if o20 = ssz.ReadOffset(buf[501:505]); o20 > size || o19 > o20 {
		return ssz.ErrOffset
	}
