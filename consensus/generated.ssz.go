...
// Hash: 113779c16dab0f5383f48a144c6aa26e324617936a193496f262bc5d420ac3e7
package pbc
...
func (s *State) UnmarshalSSZ(buf []byte) error {
	...
	// Field (19) 'ReserviorBalance'
	s.ReserviorBalance = ssz.UnmarshallUint64(buf[521:529])

	// Offset (20) 'Storage'
	if o20 = ssz.ReadOffset(buf[529:533]); o20 > size || o11 > o20 {
		return ssz.ErrOffset
	}
