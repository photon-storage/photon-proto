...
// Hash: 8cfa6f3b86105fa2eabc867028ae17ecc6548eaeda16eb087c225b66087b223f
package pbc
...
func (b *BlockBody) UnmarshalSSZ(buf []byte) error {
	...
	{
		buf = tail[o2:o3]
		num, err := ssz.DivideInt2(len(buf), 1816, 1024)
		if err != nil {
			return err
		}
		...
		for ii := 0; ii < num; ii++ {
			...
			if err = b.Txs[ii].UnmarshalSSZ(buf[ii*1816 : (ii+1)*1816]); err != nil {
				return err
			}
		}
	}
...
func (s *StorageContract) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (9) 'Bond'
	dst = ssz.MarshalUint64(dst, s.Bond)
...
func (s *StorageContract) UnmarshalSSZ(buf []byte) error {
	...
	// Field (9) 'Bond'
	s.Bond = ssz.UnmarshallUint64(buf[224:232])
...
func (a *Audit) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (3) 'SectorsPerBlock'
	dst = ssz.MarshalUint32(dst, a.SectorsPerBlock)
...
func (a *Audit) UnmarshalSSZ(buf []byte) error {
	...
	if cap(a.EncodedHash) == 0 {
		a.EncodedHash = make([]byte, 0, len(buf[0:32]))
	}
	a.EncodedHash = append(a.EncodedHash, buf[0:32]...)

	// Field (1) 'EncodedSize'
	a.EncodedSize = ssz.UnmarshallUint64(buf[32:40])

	// Field (2) 'NumBlocks'
	a.NumBlocks = ssz.UnmarshallUint32(buf[40:44])

	// Field (3) 'SectorsPerBlock'
	a.SectorsPerBlock = ssz.UnmarshallUint32(buf[44:48])

	// Offset (4) 'Rands'
	if o4 = ssz.ReadOffset(buf[48:52]); o4 > size {
		return ssz.ErrOffset
	}
...
func (a *Audit) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field (3) 'SectorsPerBlock'
	hh.PutUint32(a.SectorsPerBlock)
...
func (s *State) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (7) 'PreviousJustifiedCheckpoint'
	...
	// Field (8) 'CurrentJustifiedCheckpoint'
	...
	// Field (14) 'AccountRoot'
	if len(s.AccountRoot) != 32 {
		err = ssz.ErrBytesLength
		return
	}
	dst = append(dst, s.AccountRoot...)

	// Field (15) 'ValidatorRoot'
	if len(s.ValidatorRoot) != 32 {
		err = ssz.ErrBytesLength
		return
	}
	dst = append(dst, s.ValidatorRoot...)

	// Field (16) 'AuditorRoot'
	if len(s.AuditorRoot) != 32 {
		err = ssz.ErrBytesLength
		return
	}
	dst = append(dst, s.AuditorRoot...)

	// Field (17) 'StorageRoot'
	if len(s.StorageRoot) != 32 {
		err = ssz.ErrBytesLength
		return
	}
	dst = append(dst, s.StorageRoot...)

	// Field (18) 'AuditQueueRoot'
...
func (s *State) UnmarshalSSZ(buf []byte) error {
	...
	tail := buf
	var o4, o5, o10, o11, o12, o13, o20 uint64
	...
	// Offset (4) 'RandaoMixes'
	if o4 = ssz.ReadOffset(buf[160:164]); o4 > size {
		return ssz.ErrOffset
	}
	...
	if cap(s.JustificationBits) == 0 {
		s.JustificationBits = make([]byte, 0, len(buf[168:169]))
	}
	s.JustificationBits = append(s.JustificationBits, buf[168:169]...)

	// Field (7) 'PreviousJustifiedCheckpoint'
	if s.PreviousJustifiedCheckpoint == nil {
		s.PreviousJustifiedCheckpoint = new(Checkpoint)
	}
	if err = s.PreviousJustifiedCheckpoint.UnmarshalSSZ(buf[169:209]); err != nil {
		return err
	}
	...
	if err = s.CurrentJustifiedCheckpoint.UnmarshalSSZ(buf[209:249]); err != nil {
		return err
	}
	...
	if err = s.FinalizedCheckpoint.UnmarshalSSZ(buf[249:289]); err != nil {
		return err
	}

	// Offset (10) 'Balances'
	if o10 = ssz.ReadOffset(buf[289:293]); o10 > size || o5 > o10 {
		return ssz.ErrOffset
	}
	...
	// Offset (13) 'CurrentEpochParticipation'
	if o13 = ssz.ReadOffset(buf[301:305]); o13 > size || o12 > o13 {
		return ssz.ErrOffset
	}

	// Field (14) 'AccountRoot'
	if cap(s.AccountRoot) == 0 {
		s.AccountRoot = make([]byte, 0, len(buf[305:337]))
	}
	s.AccountRoot = append(s.AccountRoot, buf[305:337]...)

	// Field (15) 'ValidatorRoot'
	if cap(s.ValidatorRoot) == 0 {
		s.ValidatorRoot = make([]byte, 0, len(buf[337:369]))
	}
	s.ValidatorRoot = append(s.ValidatorRoot, buf[337:369]...)

	// Field (16) 'AuditorRoot'
	if cap(s.AuditorRoot) == 0 {
		s.AuditorRoot = make([]byte, 0, len(buf[369:401]))
	}
	s.AuditorRoot = append(s.AuditorRoot, buf[369:401]...)

	// Field (17) 'StorageRoot'
	if cap(s.StorageRoot) == 0 {
		s.StorageRoot = make([]byte, 0, len(buf[401:433]))
	}
	s.StorageRoot = append(s.StorageRoot, buf[401:433]...)

	// Field (18) 'AuditQueueRoot'
	if cap(s.AuditQueueRoot) == 0 {
		s.AuditQueueRoot = make([]byte, 0, len(buf[433:465]))
	}
	s.AuditQueueRoot = append(s.AuditQueueRoot, buf[433:465]...)

	// Field (19) 'EventQueueRoot'
	if cap(s.EventQueueRoot) == 0 {
		s.EventQueueRoot = make([]byte, 0, len(buf[465:497]))
	}
	s.EventQueueRoot = append(s.EventQueueRoot, buf[465:497]...)

	// Offset (20) 'Storage'
	if o20 = ssz.ReadOffset(buf[497:501]); o20 > size || o13 > o20 {
		return ssz.ErrOffset
	}
...
func (s *Storage) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (2) 'RewardPerByte'
	dst = ssz.MarshalUint64(dst, s.RewardPerByte)
...
func (s *Storage) UnmarshalSSZ(buf []byte) error {
	...
	// Field (2) 'RewardPerByte'
	s.RewardPerByte = ssz.UnmarshallUint64(buf[12:20])
...
func (t *Transaction) UnmarshalSSZ(buf []byte) error {
	...
	if err = t.TxDataAuditorDeposit.UnmarshalSSZ(buf[144:152]); err != nil {
		return err
	}
	...
	if err = t.TxDataObjectCommit.UnmarshalSSZ(buf[152:352]); err != nil {
		return err
	}
	...
	if err = t.TxDataObjectAudit.UnmarshalSSZ(buf[352:1336]); err != nil {
		return err
	}
	...
	if err = t.TxDataObjectPoR.UnmarshalSSZ(buf[1336:1720]); err != nil {
		return err
	}
...
func (t *TxDataObjectCommit) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (7) 'Bond'
	dst = ssz.MarshalUint64(dst, t.Bond)
...
func (t *TxDataObjectCommit) UnmarshalSSZ(buf []byte) error {
	...
	// Field (5) 'Duration'
	t.Duration = Slot(ssz.UnmarshallUint64(buf[168:176]))

	// Field (6) 'Fee'
	t.Fee = ssz.UnmarshallUint64(buf[176:184])

	// Field (7) 'Bond'
	t.Bond = ssz.UnmarshallUint64(buf[184:192])

	// Field (8) 'Deadline'
	t.Deadline = Slot(ssz.UnmarshallUint64(buf[192:200]))
...
func (t *TxDataObjectAudit) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (8) 'SectorsPerBlock'
	dst = ssz.MarshalUint32(dst, t.SectorsPerBlock)
...
func (t *TxDataObjectAudit) UnmarshalSSZ(buf []byte) error {
	...
	// Field (8) 'SectorsPerBlock'
	t.SectorsPerBlock = ssz.UnmarshallUint32(buf[212:216])

	// Field (9) 'Rands'
	t.Rands = make([][]byte, 8)
	for ii := 0; ii < 8; ii++ {
		if cap(t.Rands[ii]) == 0 {
			t.Rands[ii] = make([]byte, 0, len(buf[216:984][ii*96:(ii+1)*96]))
		}
		t.Rands[ii] = append(t.Rands[ii], buf[216:984][ii*96:(ii+1)*96]...)
	}
...
func (t *TxDataObjectAudit) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	...
	// Field (8) 'SectorsPerBlock'
	hh.PutUint32(t.SectorsPerBlock)
...
func (s *SignedTransaction) UnmarshalSSZ(buf []byte) error {
	...
	if err = s.Tx.UnmarshalSSZ(buf[0:1720]); err != nil {
		return err
	}

	// Field (1) 'Signature'
	if cap(s.Signature) == 0 {
		s.Signature = make([]byte, 0, len(buf[1720:1816]))
	}
	s.Signature = append(s.Signature, buf[1720:1816]...)
