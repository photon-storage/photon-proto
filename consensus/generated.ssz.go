...
// Hash: 148dbe1c11ebc3548a8f4af0e481a4743b49f0f0d3d4a555c7366863eb13f55a
package pbc
...
func (b *BlockBody) UnmarshalSSZ(buf []byte) error {
	...
	{
		buf = tail[o2:o3]
		num, err := ssz.DivideInt2(len(buf), 2400, 1024)
		if err != nil {
			return err
		}
		...
		for ii := 0; ii < num; ii++ {
			...
			if err = b.Txs[ii].UnmarshalSSZ(buf[ii*2400 : (ii+1)*2400]); err != nil {
				return err
			}
		}
	}
...
func (t *Transaction) UnmarshalSSZ(buf []byte) error {
	...
	if err = t.TxDataObjectChallenge.UnmarshalSSZ(buf[1888:1920]); err != nil {
		return err
	}
	...
	if err = t.TxDataObjectPoR.UnmarshalSSZ(buf[1920:2304]); err != nil {
		return err
	}
...
func (s *SignedTransaction) UnmarshalSSZ(buf []byte) error {
	...
	if err = s.Tx.UnmarshalSSZ(buf[0:2304]); err != nil {
		return err
	}

	// Field (1) 'Signature'
	if cap(s.Signature) == 0 {
		s.Signature = make([]byte, 0, len(buf[2304:2400]))
	}
	s.Signature = append(s.Signature, buf[2304:2400]...)
