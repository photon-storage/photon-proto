...
// Hash: 325edf61f94944d584634492962a5734dd313b06580fcdc9d9c922e2d72332c5
package pbc
...
func (b *BlockBody) UnmarshalSSZ(buf []byte) error {
	...
	{
		buf = tail[o2:o3]
		num, err := ssz.DivideInt2(len(buf), 2368, 1024)
		if err != nil {
			return err
		}
		...
		for ii := 0; ii < num; ii++ {
			...
			if err = b.Txs[ii].UnmarshalSSZ(buf[ii*2368 : (ii+1)*2368]); err != nil {
				return err
			}
		}
	}
...
func (t *Transaction) UnmarshalSSZ(buf []byte) error {
	...
	if err = t.TxDataObjectPoR.UnmarshalSSZ(buf[1888:2272]); err != nil {
		return err
	}
...
func (t *TxDataObjectCommit) UnmarshalSSZ(buf []byte) error {
	...
	// Field (10) 'Bond'
	t.Bond = ssz.UnmarshallUint64(buf[228:236])
...
func (s *SignedTransaction) UnmarshalSSZ(buf []byte) error {
	...
	if err = s.Tx.UnmarshalSSZ(buf[0:2272]); err != nil {
		return err
	}

	// Field (1) 'Signature'
	if cap(s.Signature) == 0 {
		s.Signature = make([]byte, 0, len(buf[2272:2368]))
	}
	s.Signature = append(s.Signature, buf[2272:2368]...)
