...
// Hash: 64f15220a96d29818f7d1aad840b0c7616a1f2b16b14d72edf377d561aa94678
package pbc
...
func (b *BlockBody) UnmarshalSSZ(buf []byte) error {
	...
	{
		buf = tail[o2:o3]
		num, err := ssz.DivideInt2(len(buf), 2328, 1024)
		if err != nil {
			return err
		}
		...
		for ii := 0; ii < num; ii++ {
			...
			if err = b.Txs[ii].UnmarshalSSZ(buf[ii*2328 : (ii+1)*2328]); err != nil {
				return err
			}
		}
	}
...
func (t *Transaction) UnmarshalSSZ(buf []byte) error {
	...
	if err = t.TxDataObjectCommit.UnmarshalSSZ(buf[664:864]); err != nil {
		return err
	}
	...
	if err = t.TxDataObjectAudit.UnmarshalSSZ(buf[864:1848]); err != nil {
		return err
	}
	...
	if err = t.TxDataObjectPoR.UnmarshalSSZ(buf[1848:2232]); err != nil {
		return err
	}
...
func (s *SignedTransaction) UnmarshalSSZ(buf []byte) error {
	...
	if err = s.Tx.UnmarshalSSZ(buf[0:2232]); err != nil {
		return err
	}

	// Field (1) 'Signature'
	if cap(s.Signature) == 0 {
		s.Signature = make([]byte, 0, len(buf[2232:2328]))
	}
	s.Signature = append(s.Signature, buf[2232:2328]...)
