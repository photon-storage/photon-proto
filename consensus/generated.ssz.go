...
// Hash: 9f6b1e641e39cf42ce9739a7c60868fabf85286216632bb4de9f36cd2ae6eb08
package pbc
...
func (s *StorageContract) UnmarshalSSZ(buf []byte) error {
	...
	if cap(s.PorChallengeHash) == 0 {
		s.PorChallengeHash = make([]byte, 0, len(buf[324:356]))
	}
	s.PorChallengeHash = append(s.PorChallengeHash, buf[324:356]...)
