...
func TestMath_Mul64(t *testing.T) {
	...
	for _, tt := range tests {
		got, err := pbc.Mul64(tt.args.a, tt.args.b)
		if tt.err && err == nil {
...
func TestMath_Div64(t *testing.T) {
	...
	for _, tt := range tests {
		got, err := pbc.Div64(tt.args.a, tt.args.b)
		if tt.err && err == nil {
...
func TestMath_Add64(t *testing.T) {
	...
	for _, tt := range tests {
		got, err := pbc.Add64(tt.args.a, tt.args.b)
		if tt.err && err == nil {
...
func TestMath_Sub64(t *testing.T) {
	...
	for _, tt := range tests {
		got, err := pbc.Sub64(tt.args.a, tt.args.b)
		if tt.err && err == nil {
...
func TestMath_Mod(t *testing.T) {
	...
	for _, tt := range tests {
		got, err := pbc.Mod64(tt.args.a, tt.args.b)
		if tt.err && err == nil {
